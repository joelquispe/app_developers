...
class JavaProyectsClassPage extends StatefulWidget {
  JavaProyectsClassPage({Key? key}) : super(key: key);
 
  @override
  State<JavaProyectsClassPage> createState() => _JavaProyectsClassPageState();
}

class _JavaProyectsClassPageState extends State<JavaProyectsClassPage> {
  @override
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.all(Radius.circular(10)),
                        child: Image(
                          image: AssetImage(JavaProyects[0].imagen),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    onTap: () async {
                      final String url = JavaProyects[0].link;
